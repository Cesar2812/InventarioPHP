<div class="container is-fluid mb-6">
	...
	<h2 class="subtitle has-text-centered">ACTUALIZAR IMAGEN DEL PRODUCTO</h2>
...
<div class="container pb-6 pt-6">
	...
	<div class="columns">
		<div class="column is-two-fifths">
			<?php if(is_file("./img/producto/".$datos['photo'])){ ?>
			<figure class="image mb-6">
			  	<img src="./img/producto/<?php echo $datos['photo']; ?>">
			</figure>
		...
		<div class="column">
			<form class="mb-6 has-text-centered FormularioAjax" action="./php/producto_img_actualizar.php" method="POST" enctype="multipart/form-data" autocomplete="off" >
				...
				<h4 class="title is-4 mb-6"><?php echo $datos['nameProduct']; ?></h4>
