<?php
    ...
    $check_producto=$check_producto->query("SELECT * FROM product WHERE id='$product_id'");
    ...
    /* Nombre de la imagen */
    $img_nombre=renombrar_fotos($datos['nameProduct']);
    ...
    $actualizar_producto=$actualizar_producto->prepare("UPDATE product SET photo=:foto WHERE id=:id");
